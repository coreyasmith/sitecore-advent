...
![Header image](./asset-management-access-rights.png)
...
![Group policy rule](./group-policy-rule.png)
...
![Condition created by user](./condition-created-by-user.png)
...
![Portal page rule](./portal-page-rule.png)
...
![No restrictions condition](./no-restrictions.png)
