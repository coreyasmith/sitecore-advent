---
title: "What Are the Costs of NOT Having an Accessible Website and Why Should You Care"
author: "Anna Pokorná"
pubDate: 2025-12-19
...
![Accessibility Hands](./accessibility-hands.png)
...
![16% internet users with a disability worldwide. 97.4% of websites fail to comply with accessibility requirements. 80mil. People in the European Union currently have a disability](./accessibility-percentages.png)
...
![Accessibility Hands](./accessibility-keyboard.png)
...
- be aware that Rich Text Editor allows accessible markup (e.g., no `<font>` tags).
...
![Actum Digital Accessibility site light mode](./actum-light-mode.png)

![Actum Digital Accessibility site dark mode](./actum-dark-mode.png)
