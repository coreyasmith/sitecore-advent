...
![Practical SitecoreAI Extensions Hero](./hero.png)
...
![App when shown on the dashboard](./image-1.png)

![App showing the results when filling in a url](./image-2.png)
...
![Example of a heatmap result](./image-3.png)
...
![Create API key for Mouseflow](./image-4.png)
...
![Screenshot of working example](./image-5.png)
...
![Component styled with Copilot](./image-6.png)
