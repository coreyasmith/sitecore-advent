...
![Mobile App Back end High Level Infrastructure](./mobile-app-environments-security-for-documentation.png)
...
![Mobile App Back end High Level Sitecore Related Workloads](./mobile-app-sitecore-related-workloads.png)
