...
![Attribute Use for Feature configuration](./attribute_useforfeature.png)
...
![Suggestion Blocks Autocomplete configuration](./suggestion_blocks_autocomplete.png)
...
![Generated suggestions view](./generated_suggestions.png)
...
![Job list component](./joblist_component.png)
...
![Job number search example](./job_number.png)
...
![Prefix Match analyzer configuration](./prefix_match_analyzer.png)
...
![Integrate Sitecore Search with Workday jobs thumbnail](./integrate-sitecore-search-with-workday-jobs.png)
...
![Empty term suggestions](./empty_term_suggestions.png)
...
![Building Sitecore Search powered Components thumbnail](./building-sitecore-search-powered-components-1.png)
